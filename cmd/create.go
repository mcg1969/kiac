...
func init() {
	...
	f.StringSliceVar(&createCfg.DNS, "dns", nil, "nameserver IPs for the node VMs (default: the network gateway plus 1.1.1.1 and 8.8.8.8, so image pulls survive VPN software that takes over the host's port 53)")
