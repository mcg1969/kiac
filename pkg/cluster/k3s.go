...
// kubeadm path only.
func k3sServerRunOpts(cfg Config, nodeName, token string, dns nodeDNSConfig) runtime.RunOpts {
...
func k3sAgentRunOpts(cfg Config, nodeName string, env []string, dns nodeDNSConfig) runtime.RunOpts {
